...
The orange density plot in each graph signifies the density plot for all shelves. As can be seen from the graph, the distribution of sugar per serving appears to be bimodal with the main peak having a wider spread than the smaller one. This is in part due to the second shelf having cereals with higher sugar content compared to those on the other shelves. Also, it is possible that within one shelf, cereal types change from one end of the shelf to the other, attributing to the bimodal shape. For example, within one shelf, supermarkets can place cereals that cater to both children and adults. Cereals with higher sugar, fat, and sodium contents are more popular amongst children while adults might prefer a healthier alternative. The second shelf (which is eye level for a child) caters more to children having cereals with higher sugar, fat, and sodium content than those placed on other shelves. Yet, its distribution for each nutritional composition is bimodal which can be potentially explained by the need for healthier alternatives desirable by adults. 

Clues of potential preference differences between children and adult are also shown through the different cereal nutritional compositions of each shelf. For example, unlike the second shelf which seems to target children, the third shelf (which is eye level for an adult) carries cereals with lower sugar, fat, and sodium level that fall in line more to the adult demographic. The density plot of fat per serving and sodium per serving, although appearing bimodal in shape, are not as distinct. The distribution of fat per serving is more positively skewed with few cereals having higher fat content overall while the distribution of sodium per serving is more negatively skewed with few cereals having less sodium content overall.

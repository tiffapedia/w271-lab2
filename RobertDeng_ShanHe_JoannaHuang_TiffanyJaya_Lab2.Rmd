...
Cereal manufacturers are willing to pay additional price to place their product where it can increase sales. The variable shelf indicates the shelf (from teh floor) where the product was placed. We will examine if there is evidence ...

We will examine if the cereal's nutritional compositions (sugar, fat, and sodium) vary by shelf height. 

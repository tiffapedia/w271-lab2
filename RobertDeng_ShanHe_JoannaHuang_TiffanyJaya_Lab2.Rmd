...
TODO: It's a cool library. Bilder does not use this library though. If we wanted to include it, we have to explain the function extensively. Plus, I don't think this section is quite necessary to answer the question. 
...
If we looked at the other explanatory variables individually, they are not as good of an indicator for the estimated probability for a shelf as much as sugar shown in Figure 1. 

![Estimated multinomial regression model for the data where fat (left) and sodium (right) are the only explanatory variable included in the model](./image/pi_hat_vs_exp.jpg)
